!(function (n) {
    ...
    n("#side-menu").metisMenu(),
        ...
        n("#sidebar-menu a").each(function () {
            ...
            // console.log(path);
            var anchorElement = $('a[href="' + path + '"]');
            var parentElement = anchorElement.parent();
            // console.log(anchorElement);
            // console.log(parentElement);


            // Add the "active" class to the anchor element and its parent
            anchorElement.addClass("active");
            parentElement.addClass("active");

            n(anchorElement).addClass("active"),
                n(anchorElement).parent().addClass("mm-active"),
                n(anchorElement).parent().parent().addClass("mm-show"),
                n(anchorElement).parent().parent().prev().addClass("mm-active"),
                n(anchorElement).parent().parent().parent().addClass("mm-active"),
                n(anchorElement).parent().parent().parent().parent().addClass("mm-show"),
                n(anchorElement)
                    .parent()
                    .parent()
                    .parent()
