...
<form class="custom-validation" action="{{route('create-email-template')}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header">New Email Template</h5>
                <div class="card-body">
                    ...
                    <form class="custom-validation" action="{{route('create-email-template')}}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email_variable" id="email_variable" value="{{old('email_variable')}}" required class="form-control"  placeholder="No_spaces"/>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="email_group" id="email_group" value="{{old('email_group')}}" required class="form-control"  placeholder=""/>
                                    @error('email_group')
                                        <ul class="parsley-danger parsley-errors-list filled" ><li class="parsley-required">{{ $message }}</li></ul>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="" style="margin-top: 48px;">
                                    <input class="form-check-input" name="default_item" id="default_item" type="checkbox" id="formCheck1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label>Subject</label>
                                    <input type="text" name="subject" id="subject" value="{{old('subject')}}" required class="form-control"  placeholder=""/>
                                    @error('subject')
                                        <ul class="parsley-danger parsley-errors-list filled" ><li class="parsley-required">{{ $message }}</li></ul>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    @error('template_body')
                                        <ul class="parsley-danger parsley-errors-list filled" ><li class="parsley-required">{{ $message }}</li></ul>
                                    @enderror
                                    <textarea id="elm1" name="template_body">{{old('template_body')}}</textarea>
                                </div>
                            </div>
                        </div>
