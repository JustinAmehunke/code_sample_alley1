    ...
    <div class="row">
        <div class="col-12">
             <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                 <h4 class="mb-sm-0"> Submission Report</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="" action="{{route('document.initiate.submission.report')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <div class="input-daterange input-group" id="datepicker6" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container="#datepicker6">
                                        ...
                                        <input type="text" class="form-control from-to-datepicker" name="start_date" placeholder="Start Date" required>
                                        <span class="input-group-text">To</span> 
                                        <input type="text" class="form-control from-to-datepicker" name="end_date" placeholder="End Date" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="payment_received" class="form-label">Premium Payment Status</label>

                                    <select class="form-select" id="payment_received" name="payment_received">
                                        {{-- <option selected="" disabled="" value="">Choose...</option> --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @endphp
                                    <select class="form-select" name="uploaded_by" id="uploaded_by" >
                                        {{-- <option selected="" disabled="" value="">Choose...</option> --}}
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @endphp
                                    <select class="form-select" name="doc_status" id="doc_status">
                                        {{-- <option selected="" disabled="" value="">Choose...</option> --}}
                                        <option value=''>ALL</option>
