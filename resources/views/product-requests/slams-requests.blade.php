    ...
    <div class="row">
       <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">SLAMS Requests</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Product Request</a></li>
                        <li class="breadcrumb-item active">SLAMS Requests</li>
                    </ol>
                </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="card-title">SLAMS Requests</h4>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('document.get-slams.requests') }}",
                    type: "POST",
                    data: function (data) {
