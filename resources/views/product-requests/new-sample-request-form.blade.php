        ...
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header">
                    Policy Number: <span id="policy-number">2001OMEP000223</span> 
                </h5>
                ...
                <div class="card-body">
                    ...
                    {{-- <form id="form_step_1" class="step" action="/test1" method="POST" >
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="btn_view_department" class="btn btn-primary waves-effect waves-light">Save & Proceed</button>
                            </div>
                        </div>
                    </form>
                      <!-- Step 2: -->
                    <form id="form_step_2" class="step" action="#" method="POST" >
                        ...
                        <div class="modal-footer">
                            <span class="showajaxfeed" id="showajax_feed_view_department"></span>
                            <button type="button" class="btn btn-light waves-effect prev" >Back</button> 
                            <button type="submit" id="btn_view_department" class="btn btn-primary waves-effect waves-light">Save & Proceed</button>
                        </div>
                    </form>
                      <!-- Step 3: -->
                    <form id="form_step_3" class="step" action="#" method="POST" >
                        ...
                        <div class="modal-footer">
                            <span class="showajaxfeed" id="showajax_feed_view_department"></span>
                            <button type="button" class="btn btn-light waves-effect prev" >Back</button>
                            <button type="submit" id="btn_view_department" class="btn btn-primary waves-effect waves-light">Finish Application</button>
                        </div>
                    </form> --}}
                            ...
                            <div class="col-md-8 form-content" id="priv_show">
                                <div class="col-md-12" id="panel_for_stage_0">
                                    ...
                                    <div class="panel-body panel-form">
                                        ...
                                        <div class="modal-footer">
                                            <span class="showajaxfeed" id="showajax_feed_view_department"></span>
                                            <button type="submit" id="btn_view_department" class="btn btn-primary waves-effect waves-light">Start Application</button>
                                        </div>
                                ...
                                <div class="panel-body panel-form">
                                    <div class="col-md-12">
                                        ...
                                        <div class="modal-footer">
                                            <span class="showajaxfeed" id="showajax_feed_view_department"></span>
                                            <button type="button" class="btn btn-light waves-effect prev" >Back</button>
                                            <button type="submit" id="finish_appication" class="btn btn-primary waves-effect waves-light">Finish Application</button>
                                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-dismiss="modal">Agree</button>
                    </div>
                </div>
            </div>
        </div>
