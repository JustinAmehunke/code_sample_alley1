...
{{-- <form class="custom-validation" action="{{route('update-company-profile')}}" method="post" enctype="multipart/form-data"> --}}
                    ...
                    <div class="">
                        ...
                        <div class="card-body card-body-grey">
                            ...
                            <!--
                                ...
                                ----------------------------------------------------------------------------------------------------------------
                            -->
                            <form id="form_step_1" style="display: none" class="step custom-validation" action="{{route('save-update-claim-request')}}" method="POST" >
                                @csrf
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="col-md-8 form-content" id="panel_for_stage_3">
                                        ...
                                        <div class="panel-body panel-form">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="tin">TIN Default :</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="policy_number">Policy/Proposal Number
                                                    *:</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <input class="form-control" type="text" id="id_number" name="id_number" value="" required />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="reason_for_claim">Reason For Claim
                                                    *:</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <select onchange="set_other_reason_for_claim(this);" name="reason_for_claim" id="reason_for_claim" class="form-select" required>
                                                        <option value=""></option>
                                                        <option value="MISSELLING">MISSELLING</option>
                                                        <option value="AFFORDABILITY ISSUES">AFFORDABILITY ISSUES</option>
                                                        <option value="SCHOOL FEES">SCHOOL FEES</option>
                                                        <option value="PERSONAL REASONS">PERSONAL REASONS</option>
                                                        <option value="FINANCIAL CONSTRAINTS">FINANCIAL CONSTRAINTS</option>
                                                        <option value="PART WITHDRAWAL NOT DUE BUT URGENT NEED FOR MONEY">PART WITHDRAWAL NOT
                                                            DUE BUT URGENT NEED FOR MONEY</option>
                                                        <option value="CURRENT FINANCIAL EVENTS">CURRENT FINANCIAL EVENTS</option>
                                                        <option value="CHILD SUPPORT">CHILD SUPPORT</option>
                                                        <option value="CLIENT HAS TO TRAVEL A GOOD DISTANCE IN ORDER TO ACCESS A CLAIM">CLIENT
                                                            HAS TO TRAVEL A GOOD DISTANCE IN ORDER TO ACCESS A CLAIM</option>
                                            ...
                                            <div class="form-group" id="other_reason_for_claim_holder" style="display: none;">
                                                <label class="form-label" for="other_reason_for_claim">Reason For Claim *
                                                    :</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <!--
                                                    ...
                                                    -->
                                                    <input class="form-control" type="text" id="other_reason_for_claim" name="other_reason_for_claim" value="" required />
                                                </div>
                                            </div>
                            ...
                            <form id="form_step_2" style="display: none" class="step custom-validation" action="{{route('save-update-claim-request')}}" method="POST" >
                                @csrf
                                <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                                <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                                <input type="hidden" name="product_name" value="EDUCATOR" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <select id="payment_method" 
                                                        name="payment_option" class="form-select" required>
                                                        <option value=""></option>
                            ...
                            <form id="form_step_3" style="display: none" class="step custom-validation" action="{{route('save-update-claim-request')}}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                                <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
    ...
    <script>
        ...
        $('select[name="payment_option"]').change(function(){
             // Get the selected value
             let selectedValue = $('select[name="payment_option"]').val();
