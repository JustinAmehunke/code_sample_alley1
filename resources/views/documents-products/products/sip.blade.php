            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_1" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_2" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_3" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_5" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                            ...
                            <div class="col-md-8 form-content" id="panel_for_stage_3">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control occupation" type="text" id="occupation" name="occupation"
                                                value="" required />
                                        </div>
                                    </div> --}}
                     ...
                     <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_6" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_7" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_8" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_9" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_10" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_11" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
...
@section('application-status-script')
    ...
    <script>
                ...
                $('#payment_option').append(`
                    <span id="momo_payment" class="form-group" >
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <select class="form-select" id="telco_name" name="telco_name" required>
                ...
                $('#payment_option').append(`
                    <span id="cag_payment" class="form-group" >
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control employer" type="text" id="appended_employer" name="employer" required/>
                            </div>
                        </div>
                        <div class="form-group" style=" margin-bottom: 10px;">
                            <label class="form-label" for="staff_id">Staff ID *:</label>
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control" type="text" id="staff_id" name="staff_id" required/>
                            </div>
                        </div>
                        <div class="form-group" style=" margin-bottom: 10px;">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control" type="text" id="office_building_location"
                                    name="office_building_location" required/>
                            </div>
                        </div>
                    </span>
                `);
        ...
        $(document).on("input", "#appended_employer", function () {
            console.log('hi get employer');
            const depdropurl = "/document/ajax_calls/dependent_dropdowns?";
                $('#appended_employer').flexdatalist({
                    selectionRequired: true,
                    removeOnBackspace: true,
                    valueProperty: "emp_code",
                    minLength: 1,
