            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_1" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" >
                        @csrf
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_2" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="date"
                                                min="{{ change_date(date('Y-m-d H:i:s'), '-70 years', 'Y-m-d'); }}"
                                                max="{{ change_date(date('Y-m-d H:i:s'), '-0 years', 'Y-m-d'); }}"
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_3" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_4" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8 form-content"  id="panel_for_stage_2">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Travel & Policy</h4>
                                </div>
                                <div class="panel-body panel-form">
                                    <div class="form-group">
                                        <label class="form-label" for="date_of_departure">Date of departure
                                            *:</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" onblur="setPremium()" type="date"
                                                min="<?php echo date('Y-m-d') ?>" id="date_of_departure" name="date_of_departure"
                                                value="" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" onblur="setPremium()" type="date"
                                                min="<?php echo date('Y-m-d') ?>" id="date_of_return" name="date_of_return" value=""
                                                required />
                                            <ul class="parsley-errors-list filled" id="travel-date" aria-hidden="false" style="display: none;">
                                                <li class="parsley-required" id="travel-date-li">This value is required.</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="premium">Premium (GHS) * :</label>
                                    <div class="col-md-12 col-sm-12 mb-3">
                                        <input class="form-control" type="number" min="1" readonly id="premium" name="premium"
                                            value="" required />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 col-sm-12 mb-3">
                                        <input class="form-control occupation" type="text" id="occupation" name="occupation" value=""
                                            required />
                                    </div>
                                </div>
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_5" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <select id="payment_method" 
                                                ...
                                                <option value="Mobile Money">Mobile Money/Card Payment</option>
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_6" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                            ...
                            <div class="col-md-8 form-content" id="panel_for_stage_5">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="health_issues2">
                                        Are you presently in good health. free from diseases or sickness* :
                                    </span>
                                    <br><br>
                                    <div class="form-group">
                                        <div class="col-md-offset-3 col-md-3 col-sm-3">
                                            <input class="form-group-input" onclick="toggle_illment_details_field_display(this)"
                                                type="radio" name="free_from_sickness" id="health_issues1" value="Yes" required>
                                        ...
                                        <div class="col-md-3 col-sm-3">
                                            <input class="form-group-input" onclick="toggle_illment_details_field_display(this)"
                                                type="radio" name="free_from_sickness" id="health_issues2" value="No">
                                    ...
                                    <div class="form-group" id="illment_description_holder" style="display: none;">
                                        <label class="form-label" for="illment_description">If no, please give details *:</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_7" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_8" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_9" style="display: none" class="step custom-validation" action="{{route('save-update-travelinsurance-request')}}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
...
@section('application-status-script')
    ...
    <script>
        ...
        function setPremium() {
            var departure_date = $('#date_of_departure').val();
            var return_date = $('#date_of_return').val();

            console.log("departure_date: " + departure_date);
            console.log("return_date: " + return_date);

            var days = Math.floor((Date.parse(return_date) - Date.parse(departure_date)) / 86400000);

            var curr_premium = 0;
            if (days < 1) {
                if (departure_date.trim() != "" && return_date.trim() != "") {
                    $('#premium').val('');
                    // swal("Oops!", "Please check that the date of departure and return are correct", "error");
                    $('#travel-date-li').html("Please check that the date of departure and return are correct");
                    $('#travel-date').css('display', 'block')
                    setTimeout(() => {
                ...
                curr_premium = 85;
            } else if (days >= 15 && days <= 17) {
                curr_premium = 90;
            } else if (days >= 18 && days <= 21) {
                curr_premium = 110;
            } else if (days >= 22 && days <= 31) {
                curr_premium = 150;
                ...
                if (departure_date.trim() != "" && return_date.trim() != "") {
                    $('#premium').val('');
                    // swal("Oops!", "This travel duration is not allowed", "error");
                    $('#travel-date-li').html("This travel duration is not allowed");
                    $('#travel-date').css('display', 'block')
                    setTimeout(() => {
                        $('#travel-date').css('display', 'none');
                    }, 3000);
            ...
            if (curr_premium > 0) {
                $('#premium').val(curr_premium);
            }
            console.log("days: " + days);
            console.log("premium: " + curr_premium);
