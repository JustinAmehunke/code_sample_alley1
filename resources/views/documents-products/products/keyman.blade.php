            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_1" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_2" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_3" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <form id="form_step_4" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8 form-content"  id="panel_for_stage_2">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="sum_assured">Sum Assured (Ghc)*:</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="number" id="sum_assured" name="sum_assured" value="" required />
                                        </div>
                                    </div>
                
                                    <div class="form-group" id="medicals_info" style="display: none;">
                                        <label class="control-label col-md-12 col-sm-12" for="sum_assured" style="text-align: center;"><strong>Medicals are required for sum assured of
                                                GHS100,000</strong></label>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="premium">Annual Premium (Ghc) *:</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="text" readonly min="1" id="premium" name="premium" value="" required />
                                            <ul class="parsley-errors-list filled" id="annual-premium" aria-hidden="false">
                                                <li class="parsley-required" id="annual-premium-li">This value is required.</li>
                                            </ul>
                                        </div>
                                    </div>
                      ...
                      <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_5" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                            ...
                            <div class="col-md-8 form-content"  id="panel_for_stage_2">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control occupation" type="text" id="empoyment_occupation" name="empoyment_occupation" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_6" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                     ...
                     <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_7" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8 form-content" id="panel_for_stage_4">
                                ...
                                <div class="panel-body panel-form">
                                    <div class="form-group">
                                        <label class="form-label" for="payment_term">Policy Term * :</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <select id="payment_term" onchange="set_other_payment_term(this);" name="policy_term" class="form-select" required>
                                                <option value=""></option>
                                                {{-- @php
                                                    for ($i = 5; $i < 48; $i++) {
                                    ...
                                    <div class="form-group" id="other_payment_term_holder" style="display: none;">
                                        <label class="form-label" for="other_payment_term">Other
                                            *:</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_8" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_9" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_10" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_11" style="display: none" class="step custom-validation" action="{{route('save-update-keyman-request')}}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                ...
                $('#payment_option').append(`
                    <span id="momo_payment" class="form-group" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control" type="text" id="wallet_name" name="wallet_name" readonly required />
                            </div>
                        </div>
                    </span>
                `);
                        ...
                        <div class="form-group" style=" margin-bottom: 10px;">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control" type="text" id="payment_account_holder_name"
                                    name="payment_account_holder_name" readonly required />
                            </div>
                        </div>
                    </span>
                `);
           ...
           for (let index = 0; index < $('.step').length; index++) {
            ...
            $(document).on('submit', 'form', function(e) {
                ...
                if(isValid){
                    ...
                    if(fullid == 'form_step_10'){ //can be modified based on form steps //step before signature
                    ...
                    if(fullid == 'form_step_9'){
                        ...
                        if(!underage_beneficiaries_exist){
                            $('.step').hide();
                            $('#form_step_11').show(); // if no beneficiary is a minor show last step
...
<script>
    ...
    $('#sum_assured').on('input', function() {
        ...
        if (isNaN(age) || age < 18) {
            // swal("Oops!", "You cannot be less than 18. Go back and fill your date of birth correctly ", "error");
            $('#annual-premium-li').html("You cannot be less than 18. Go back and fill your date of birth correctly ");
            $('#annual-premium').css('display', 'block')
            setTimeout(() => {
                $('#annual-premium').css('display', 'none');
            }, 3000);
            return;
        }

        var this_sum_assured = $('#sum_assured').val();
        console.log(this_sum_assured+'_'+this_dob+'_'+age);

        if (isNaN(this_sum_assured)) {
            // swal("Oops!", "Sum assured has to be a number", "error");
            $('#annual-premium-li').html("Sum assured has to be a number");
            $('#annual-premium').css('display', 'block')
            setTimeout(() => {
                $('#annual-premium').css('display', 'none');
            }, 3000);
        ...
        if (this_sum_assured == 100000) {
            $('#medicals_info').fadeIn();
        } else {
            $('#medicals_info').hide();
        }

        if (this_sum_assured > 1000000) {
            $('#sum_assured').val('');
            $('#premium').val('');
            // swal("Oops!", "The sum assured cannot be more than GHS 1,000,000", "error");
            $('#annual-premium-li').html("The sum assured cannot be more than GHS 1,000,000");
            $('#annual-premium').css('display', 'block');
            setTimeout(() => {
                $('#annual-premium').css('display', 'none');
            }, 3000);
        ...
        console.log('this_sum_assured IS: ' + this_sum_assured);
        if (age >= 18 && age <= 25) {

            this_premium = this_sum_assured * (7.41 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 26 && age <= 30) {

            this_premium = this_sum_assured * (9.5 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 31 && age <= 35) {
            this_premium = this_sum_assured * (9.75 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 36 && age <= 40) {
            this_premium = this_sum_assured * (10.01 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 41 && age <= 45) {

            this_premium = this_sum_assured * (12.53 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 46 && age <= 50) {

            this_premium = this_sum_assured * (16.27 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 51 && age <= 55) {

            this_premium = this_sum_assured * (21.09 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 56 && age <= 59) {

            this_premium = this_sum_assured * (29.83 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 61 && age <= 65) {

            this_premium = this_sum_assured * (34.83 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else {
            // swal("Oops!", "Your age makes you ineligible for this policy", "error");
            $('#annual-premium-li').html("Your age makes you ineligible for this policy. Go back to cross check it");
            $('#annual-premium').css('display', 'block');
            setTimeout(() => {
                $('#annual-premium').css('display', 'none');
            }, 3000);
