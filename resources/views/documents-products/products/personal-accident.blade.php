            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_1" style="display: none" class="step custom-validation" action="{{route('save-update-personalaccident-request')}}" method="POST" >
                        @csrf
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_2" style="display: none" class="step custom-validation" action="{{route('save-update-personalaccident-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                            ...
                            <div class="col-md-8 form-content" id="panel_for_stage_1">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control occupation" type="text" id="empoyment_occupation" name="occupation" required />
                                        </div>
                                    </div>
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_3" style="display: none" class="step custom-validation" action="{{route('save-update-personalaccident-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <form id="form_step_4" style="display: none" class="step custom-validation" action="{{route('save-update-personalaccident-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8 form-content" id="panel_for_stage_5">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <h4 class="panel-title">Medical History & Premium</h4>
                                </div>
            
                                <div class="panel-body panel-form">
            
                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="in_good_health2">
                                        Are you free from any physical defect or infirmity and are you now in and do you ordinarily
                                        enjoy good
                                        health? * :
                                    </span>
                                    <div class="form-group mt-2">
                                        <div class="col-md-offset-3 col-md-3 col-sm-3">
                                            <input class="form-group-input" 
                                                type="radio" name="in_good_health" id="in_good_health1" value="Yes" required>
                                            <label class="form-group-label" for="in_good_health1">
                                                Yes
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                            <input class="form-group-input" 
                                                type="radio" name="in_good_health" id="in_good_health2" value="No">
                                            <label class="form-group-label" for="in_good_health2">
                                                No
                                            </label>
                                        </div>
                                    </div>

                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="already_have_a_personal_accident_insurance2">
                                        Do you hold any Personal Accident Insurance * :
                                    </span>
                                    <div class="form-group mt-2">
                                        <div class="col-md-offset-3 col-md-3 col-sm-3">
                                            <input class="form-group-input" onclick="set_already_have_personal_accident_insurance_more_details_field(this)"
                                                type="radio" name="already_have_a_personal_accident_insurance" id="already_have_a_personal_accident_insurance1" value="Yes" required>
                                            <label class="form-group-label" for="already_have_a_personal_accident_insurance1">
                                                Yes
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                            <input class="form-group-input" onclick="set_already_have_personal_accident_insurance_more_details_field(this)"
                                                type="radio" name="already_have_a_personal_accident_insurance" id="already_have_a_personal_accident_insurance2" value="No">
                                            <label class="form-group-label" for="already_have_a_personal_accident_insurance2">
                                                No
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group" id="already_have_p_a_insurance_details_formholder" style="display: none;">
                                        <label class="form-label" for="already_have_a_personal_accident_insurance_details">If so, give details *:</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <textarea id="already_have_a_personal_accident_insurance_details" name="already_have_a_personal_accident_insurance_details" class="form-control"
                                                rows="2" required></textarea>
                                        </div>
                                    </div>
                                  
                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="already_have_a_life_insurance_with_us2">
                                        Do you hold Life Insurance Policy with this Company * :
                                    </span>
                                    <div class="form-group mt-2">
                                        <div class="col-md-offset-3 col-md-3 col-sm-3">
                                            <input class="form-group-input" 
                                                type="radio" name="already_have_a_life_insurance_with_us" id="already_have_a_life_insurance_with_us1" value="Yes" required>
                                            <label class="form-group-label" for="already_have_a_life_insurance_with_us1">
                                                Yes
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                            <input class="form-group-input" 
                                                type="radio" name="already_have_a_life_insurance_with_us" id="already_have_a_life_insurance_with_us2" value="No">
                                            <label class="form-group-label" for="already_have_a_life_insurance_with_us2">
                                                No
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="health_issues2">
                                        Give particulars of any illness of accident for which you have received medical attention
                                        for past five years * :
                                    </span>
                                    <div class="form-group mt-2" id="past_illness_holder" style="display: block;">
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <textarea id="past_illness" name="past_illness" class="form-control"
                                                rows="2" required></textarea>
                                        </div>
                                    </div>

                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="accident_prone_activities2">
                                        Have you any intention in activities like polo, mountaineering, yatching, racing of any kind,
                                        steeple chasing, hunting, big game shooting or motocycling? * :
                                    </span>
                                    <div class="form-group mt-2">
                                        <div class="col-md-offset-3 col-md-3 col-sm-3">
                                            <input class="form-group-input" 
                                                type="radio" name="accident_prone_activities" id="accident_prone_activities1" value="Yes" required>
                                            <label class="form-group-label" for="accident_prone_activities1">
                                                Yes
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                            <input class="form-group-input" 
                                                type="radio" name="accident_prone_activities" id="accident_prone_activities2" value="No">
                                            <label class="form-group-label" for="accident_prone_activities2">
                                                No
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="accident_prone_activities2">
                                        <b>NB: Accident resulting from the above can in certain circumstances be covered by
                                            special agreement at an additional premium * :</b>
                                    </span>
                                    <div class="form-group mt-2">
                                        <label class="form-label" for="sum_assured">Sum Assured at Death (Ghc) *
                                            :</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="number" min="1" id="sum_assured" name="sum_assured" value="" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="net_premium">Net Premium (Gh¢)* :</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="number" min="50" max="5000" id="net_premium" name="net_premium" value="" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="insurance_for_twelve_months">Commencement
                                            Month :</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="date" min="<?php echo date('Y-m-d') ?>" id="insurance_for_twelve_months" name="insurance_for_twelve_months" value="" />
                                        </div>
                                    </div>
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_5" style="display: none" class="step custom-validation" action="{{route('save-update-personalaccident-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_6" style="display: none" class="step custom-validation" action="{{route('save-update-personalaccident-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_7" style="display: none" class="step custom-validation" action="{{route('save-update-personalaccident-request')}}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
           ...
           for (let index = 0; index < $('.step').length; index++) {
            ...
            $(document).on('submit', 'form', function(e) {
                ...
                if(isValid){
                    ...
                    if(fullid == 'form_step_6'){ //can be modified based on form steps
...
<script>
    ...
    function set_already_have_personal_accident_insurance_more_details_field(x) {
        if (x.value == "Yes") {
            $('#already_have_p_a_insurance_details_formholder').fadeIn();
            $("#already_have_a_personal_accident_insurance_details").prop('required', true);
        } else {
            $('#already_have_p_a_insurance_details_formholder').hide();
            $("#already_have_a_personal_accident_insurance_details").prop('required', false);
        }
    }
