...
{{-- <form class="custom-validation" action="{{route('update-company-profile')}}" method="post" enctype="multipart/form-data"> --}}
                    ...
                    <div class="">
                        ...
                        <div class="card-body card-body-grey">
                            ...
                            <!--
                                ...
                                ----------------------------------------------------------------------------------------------------------------
                            -->
                            <form id="form_step_1" style="display: none" class="step custom-validation" action="{{route('save-update-refund-request')}}" method="POST" >
                                @csrf
                                    ...
                                    <div class="col-md-8 form-content" id="panel_for_stage_1">
                                        ...
                                        <div class="panel-body panel-form">
                                            <div class="form-group">
                                                <label class="form-label" for="claim_number">Refund Number *:</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <input class="form-control" type="text" id="claim_number" name="claim_number" value="<?= $record['policy_no'] ?>" readonly />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="policy_number">Policy/Proposal Number *:</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                            ...
                                            <div class="form-group row">
                                               <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 mb-3">
                                                        <input type="text" name="mobile" class="form-control phone-num" id="mobile" value="<?= $record['sms'] ?>" 
                                                        pattern="[0]{1}[0-9]{9}" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-sm-12 mb-3" id="id-type_cont">
                                                    {{-- <select id="id_type" name="id_type" class="form-select" required onchange="setIDRestriction(this, 'id_number')">
                                                        <option value=""></option>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="id_number">ID Number (Ghana) *:</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <input class="form-control" type="text" id="prefill-id_number" name="id_number" required readonly />
                                            ...
                                            <div class="form-group" style="display: none;">
                                                ...
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <input class="form-control" type="text" id="claim_type" name="claim_type" value="Refund" readonly required />
                                                </div>
                                            </div>
                                            <!--
                                                <div class="form-group">
                                                <label class="form-label" for="claim_percentage">Claim Percentage *:</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <input class="form-control" type="number" min="1" max="100" id="claim_percentage" name="claim_percentage" value="" required />
                                                </div>
                                            -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <select id="refund_type" onchange="set_other_reason_for_refund(this)" name="refund_type" class="form-select" required>
                                                        <option value=""></option>
                                                        <option value="Wrongful Deduction">Wrongful Deduction</option>
                                                        <option value="Over Deduction">Over Deduction</option>
                                                        <option value="Deduction After Cancellation/Surrender">Deduction After Cancellation/Surrender</option>
                                                        <option value="Other">Other</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group" id="other_reason_for_refund_holder" style="display: none;">
                                                <label class="form-label" for="other_reason_for_refund">Other Reason For Refund :</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <input class="form-control" type="text" id="other_reason_for_refund" name="other_reason_for_refund" value="" />
                                                </div>
                                            </div>
                            ...
                            <form id="form_step_2" style="display: none" class="step custom-validation" action="{{route('save-update-refund-request')}}" method="POST" >
                                @csrf
                                <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                                <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                                <input type="hidden" name="product_name" value="EDUCATOR" />
                                <div class="d-flex justify-content-center">
                                    <div class="col-md-8 form-content"id="panel_for_stage_2">
                                        <div class="panel-heading">
                                            ...
                                            <h4 class="panel-title">Source Of Payment</h4>
                                        </div>
                                        <div class="panel-body panel-form">
                        
                                            <div class="form-group">
                                                <label class="form-label" for="source_of_payment_option">What is your source of payments? * :</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <select id="source_of_payment_option" data-type="source" name="source_of_payment_option" class="form-select payment_method" required>
                                                        <option value=""></option>
                                            ...
                                            <div class="form-group" id="payment_option_source">
                              ...
                              <!--
                                    ...
                                    ----------------------------------------------------------------------------------------------------------------
                                -->
                            <form id="form_step_3" style="display: none" class="step custom-validation" action="{{route('save-update-refund-request')}}" method="POST" >
                                @csrf
                                <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                                <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                                <input type="hidden" name="product_name" value="EDUCATOR" />
                                <div class="d-flex justify-content-center">
                                    <div class="col-md-8 form-content" id="panel_for_stage_3">
                                        ...
                                        <div class="panel-body panel-form">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="payment_option">How do you want to receive the claim * :</label>
                                                <div class="col-md-12 col-sm-12 mb-3">
                                                    <select id="payment_option" data-type="claimpayment" name="claimpayment_payment_option" class="form-select payment_method" required>
                                                        <option value=""></option>
                                                        <option value="Bank">Bank</option>
                                                        <option value="Mobile Money">Mobile Money</option>
                                                    </select>
                                            ...
                                            <div class="form-group" id="payment_option_claimpayment">
                            ...
                            <form id="form_step_4" style="display: none" class="step custom-validation" action="{{route('save-update-refund-request')}}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                                <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                                        ...
                                        <div class="panel-body panel-form">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 mb-3">
                                                        <input class="form-control" type="text" id="my_name" name="my_name" required readonly />
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        $('.payment_method').change(function(){
            ...
            let typeSelected = $(this).data('type');
             console.log(selectedValue);
             console.log(typeSelected);
            $('#payment_option_'+typeSelected).empty();
            if(selectedValue == "Mobile Money"){
                $('#payment_option_'+typeSelected).append(`
                    <span id="momo_payment" class="form-group" >
                        <div class="form-group">
                            <label class="form-label" for="telco_name">Telco Operator *:</label>
                            <div class="col-md-12 col-sm-12 mb-3">
                                <select class="form-select" type="text" id="telco_name" name="${typeSelected}_of_telco_name" value="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                ...
                                pattern="[0]{1}[0-9]{9}" 
                                title="Invalid phone number"
                                    name="${typeSelected}_of_wallet_number" value="" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control" type="text" id="wallet_name" name="${typeSelected}_of_wallet_name" value="" />
                            </div>
                        </div>
                    </span>
                `);
                    ...
                    <span id="bank_payment" class="form-group" >
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                ...
                                @endphp
                                <select name="${typeSelected}_of_payment_bank_name" data-type="${typeSelected}" id="tbl_banks_id" class="form-select"
                                    onchange="get_branches_listt(this, '${typeSelected}_payment_bank_branch')">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="payment_bank_branch">Bank Branch
                                *:</label>
                            <div class="col-md-12 col-sm-12 mb-3">
                                <select class="form-select" type="text" id="${typeSelected}_payment_bank_branch"
                                    name="${typeSelected}_of_bank_branch" value="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control" type="text" id="payment_account_number"
                                    name="${typeSelected}_of_account_number" value="" />
                            </div>
                        </div>
                        ...
                        <div class="form-group" style=" margin-bottom: 10px;">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control" type="text" id="payment_account_holder_name"
                                    name="${typeSelected}_of_account_holder_name" value="" />
                            </div>
                        </div>
                    </span>
                `);
            }
            if(selectedValue == "Worksite" || selectedValue == "Stop Order"){
                $('#payment_option_'+typeSelected).append(`
                    <span id="cag_payment" class="form-group" >
                        <div class="form-group">
                            <label class="form-label" for="employer">Worksite *:</label>
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control flexdatalist" type="text" id="employer" name="${typeSelected}_of_worksite_name" value="" />
                            </div>
                        </div>
                        <div class="form-group" style=" margin-bottom: 10px;">
                            <label class="form-label" for="staff_id">Staff ID *:</label>
                            <div class="col-md-12 col-sm-12 mb-3">
                                <input class="form-control" type="text" id="staff_id" name="${typeSelected}_of_staff_number" value="" />
                            </div>
                        </div>
                    </span>
                `);
           ...
           for (let index = 0; index < $('.step').length; index++) {
            ...
            $(document).on('submit', 'form', function(e) {
                ...
                if(isValid){
                    ...
                    if(fullid == 'form_step_3'){ //can be modified based on form steps
    ...
    <script>
        ...
        function get_branches_listt(x, type) {
            console.log(type);
            // var ele = $(this);
            // var row = ele.closest('tr');
            // var organ = document.getElementById(type+"_payment_bank_branch");
        ...
        function set_other_reason_for_refund(x) {
        if (x.value == "Other") {
            $('#other_reason_for_refund_holder').fadeIn();
            $("#other_reason_for_refund").prop('required', true);
        } else {
            $('#other_reason_for_refund_holder').hide();
            $("#other_reason_for_refund").prop('required', false);
        }
    }
...
ADD COLUMN source_of_bank_branch TEXT NULL,
ADD COLUMN source_of_account_holder_name TEXT NULL,
ADD COLUMN claimpayment_payment_option TEXT NULL,
ADD COLUMN claimpayment_of_payment_bank_name TEXT NULL,
ADD COLUMN claimpayment_of_bank_branch TEXT NULL,
ADD COLUMN claimpayment_of_account_number TEXT NULL,
ADD COLUMN claimpayment_of_account_holder_name TEXT NULL,
ADD COLUMN claimpayment_of_telco_name TEXT NULL,
ADD COLUMN claimpayment_of_wallet_number TEXT NULL,
ADD COLUMN claimpayment_of_wallet_name TEXT NULL; --}}