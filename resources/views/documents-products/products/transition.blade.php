            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_1" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_2" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8 form-content" id="panel_for_stage_1">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="country_of_residence">Country Of Residence (State All If More
                                            Than One) *:</label>
                                        <div class="col-md-12 col-sm-12 mb-2">
                                            <input class="form-control" type="text" id="country_of_residence" name="country_of_residence" value=""
                                                required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_3" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <form id="form_step_4" style="display: none" class="step custom-validation" action="{{route('save-update-specialinsvestment-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                            ...
                            <div class="col-md-8 form-content" id="panel_for_stage_3">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-2">
                                            <input class="form-control" type="text" name="payer_name" required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <form id="form_step_5" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                            ...
                            <div class="col-md-8 form-content"  id="panel_for_stage_2">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-2">
                                            <input class="form-control occupation" type="text" id="empoyment_occupation" name="empoyment_occupation" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_6" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_7" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                            ...
                            <div class="col-md-8 form-content" id="panel_for_stage_3">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="health_issues2">
                                        Main life / Details of Other lives - Spouse / Children (Biological & Adopted) / Parents /
                                        Step-parents / Parents-Inlaw
                                    </span>
                                    <br><br>
                                    <div class="row" >
                                        <div class="col-md-12">
                                            <div class="row">
                                                <label class="control-label col-md-4 col-sm-4"><b>First Cover (This is you)</b></label>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4 col-sm-4" for="cover_one_sum_assured">Sum
                                                            Assured *:</label>
                                                        <div class="col-md-6 col-sm-6">
                                                            <select class="form-control all_sum_assured" type="text" onchange="calculate_premium(this)" data-cover="one" id="cover_one_sum_assured" name="sum_assured" value="" required>
                                                                <option value=""></option>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-4 col-sm-4" for="cover_one_premium">Premium *
                                                            :</label>
                                                        <div class="col-md-6 col-sm-6">
                     ...
                     <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_8" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8 form-content" id="panel_for_stage_3">
                                ...
                                <div class="panel-body panel-form">
                                    <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4" for="parents_alive">Are your parents alive *
                                            :</label>
                                        <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4" for="any_other_policy">Do you have any other
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4" for="policy_name">Policy Name (If you have a policy with
                                            us) :</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4" for="policy_number">Policy Number (If you have a policy
                                            with us) :</label>
                                        <div class="col-md-6">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_9" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8 form-content" id="panel_for_stage_5">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="health_issues2">
                                        Do you or any of the lives insured suffer from any physical impairment or current illness?
                                    </span>
                                    ...
                                    <span class="control-label col-md-12 col-sm-12" style="text-align: center;" for="health_issues2">
                                        Are any of the lives insured currently on long medication or under medical advice or investigation?
                                    </span>
                                    <div class="form-group mt-2">
                                        <div class="col-md-offset-3 col-md-3 col-sm-3">
                                            <input class="form-group-input" 
                                                type="radio" name="long_term_medication" id="long_term_medication1" value="Yes" required>
                                            <label class="form-group-label" for="long_term_medication1">
                                                Yes
                                            </label>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
                                            <input class="form-group-input" 
                                                type="radio" name="long_term_medication" id="long_term_medication2" value="No">
                                            <label class="form-group-label" for="long_term_medication2">
                                                No
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="illment_description_holder" style="display: block;">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_10" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    {{-- <form id="form_step_11" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_11" style="display: none" class="step custom-validation" action="{{route('save-update-fidosip-request')}}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                                                ...
                                                <footer class="panel-footer">
                                                    <div class="row">
                                                        <div class="col-md-12 text-right">
                                                            ...
                                                            <input class="form-check-input" id="agree-term-unset" type="checkbox" onclick="enable_submit_btn(this)" id="formCheck2" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-11">
                                                <label class="control-label modal-basic" id="model_link" href="#modalBasic"
                                                    ...
                                                    I, the undersigned, hereby declare that the information provided by me and required of me on this application
                                                    is both correct and accurate, that the option as selected herein is clear and that I understand the terms
                                                    and conditions binding this policy. I absolutely authorize Old Mutual to acquire any information
                                                    it deems essential from any person, doctor or hospital that has medical information needed in
                                                    connection with this application, including full details of my past medical history.
                                                    I am fully aware that the benefit under this policy may be cancelled and forfeited at
                                                    the company's discretion in the event that any information provided or declaration made by me is/are inaccurate.
                                                </label>
                                            </div>
                                        </div>
    ...
    function add_more_beneficiaries() {
        if (added < 10) {
            ...
            $('#beneficiaries_holder').append('<div class="col-md-12" style="margin-top: 10px" id="holder_beneficiary_' +
                ...
                position_num +
                '_relationship">Relationship *:</label><div class="col-md-12 col-sm-12 mb-2"><select name="beneficiary' +
                ...
                '_id_type[]" class="form-control" '+ `onchange="setIDRestriction(this, 'beneficiary_${position_num}_id_number')"`+ '><option value=""></option><option value="Drivers License">Drivers License</option><option value="Passport">Passport</option><option value="National ID">National ID</option><option value="Voter ID">Voter ID</option><option value="SSNIT">SSNIT</option></select></div></div></div><div class="col-md-12"><div class="form-group"><label class="form-label" for="beneficiary_' +
                position_num +
                ...
                position_num +
                '_phone_no">Phone Number :</label><div class="col-md-12 col-sm-12 mb-2"><input class="form-control phone-num" type="text" id="beneficiary_' +
    ...
    function add_more_covers() {
        if (added_covers < 7) {
            ...
            $('#cover_holder').append('<div id="holder_cover_' + added_covers +
                '" class="col-md-12"><div class="row"><label class="control-label col-md-4 col-sm-4"><b>' + position +
                '</b></label><div class="col-md-12"><div class="form-group"><label class="control-label col-md-4 col-sm-4" for="cover_' +
                position_num +
                '_surname_name">Surname Name *:</label><div class="col-md-6 col-sm-6"><input class="form-control cover_surname" type="text" id="cover_' +
                position_num + '_surname_name" name="cover_' + position_num +
                '_surname_name" value="" required /></div></div></div><div class="col-md-12"><div class="form-group"><label class="control-label col-md-4 col-sm-4" for="cover_' +
                position_num +
                '_first_name">First Name *:</label><div class="col-md-6 col-sm-6"><input class="form-control cover_first_name" type="text" id="cover_' +
                position_num + '_first_name" name="cover_' + position_num +
                '_first_name" value="" required /></div></div></div><div class="col-md-12"><div class="form-group"><label class="control-label col-md-4 col-sm-4" for="cover_' +
                position_num +
                '_dob">Date Of Birth *:</label><div class="col-md-6 col-sm-6"><input class="form-control added_dob"  min="<?php echo change_date(date('Y-m-d H:i:s'), '-150 years', 'Y-m-d'); ?>"  max="<?php echo date('Y-m-d'); ?>" type="date" id="cover_' +
                position_num + '_dob" name="cover_' + position_num +
                '_dob" value="" required /></div></div></div><div class="col-md-12"><div class="form-group"><label class="control-label col-md-4 col-sm-4" for="cover_' +
                position_num +
                '_telephone_number">Telephone Number *:</label><div class="col-md-6 col-sm-6"><input class="form-control cover_telephone_number" type="text" id="cover_' +
                position_num + '_telephone_number" name="cover_' + position_num +
                '_telephone_number" value="" required /></div></div></div><label class="control-label col-md-4 col-sm-4" for="cover_' +
                position_num + '_gender">Gender * :</label><div class="col-md-6 col-sm-6"><select id="cover_' +
                position_num + '_gender" name="cover_' + position_num +
                ...
                <div class="col-md-12"><div class="form-group"><label class="control-label col-md-4 col-sm-4" for="cover_` +
                position_num +
                '_relationship">Relationship *:</label><div class="col-md-6 col-sm-6"><select name="cover_' +
                position_num + '_relationship" id="cover_' + position_num +
                `_relationship" required class="form-control added_cover added_relationship"><option value=""></option><option value="Spouse">Spouse</option><option value="Son">Son</option><option value="Daughter">Daughter</option><option value="Mother">Mother</option><option value="Father">Father</option><option value="Step-mother">Step-mother</option><option value="Step-father">Step-father</option><option value="Father In-Law">Father In-Law</option><option value="Mother In-Law">Mother In-Law</option>
                </select></div></div></div></div>

                <div class="row"><div class="col-md-12"><div class="form-group"><label class="control-label col-md-4 col-sm-4" for="cover_` +
                position_num +
                '_sum_assured">Sum Assured *:</label><div class="col-md-6 col-sm-6"><select   onchange="calculate_premium(this)" data-cover = "' +
                position_num + '"  class="form-control all_sum_assured added_cover" type="text" id="cover_' + position_num +
                '_sum_assured" name="cover_' + position_num +
                `_sum_assured" value="" required><option value=""></option><option value="1000">1000</option><option value="1500">1500</option><option value="2000">2000</option><option value="2500">2500</option><option value="3000">3000</option><option value="4000">4000</option><option value="5000">5000</option><option value="7500">7500</option><option value="10000">10000</option><option value="12500">12500</option><option value="15000">15000</option><option value="20000">20000</option><option value="25000">25000</option><option value="30000">30000</option><option value="35000">35000</option><option value="40000">40000</option><option value="45000">45000</option><option value="50000">50000</option><option value="55000">55000</option><option value="60000">60000</option><option value="65000">65000</option><option value="70000">70000</option></select>
                <input type="text" onchange="calculate_premium(this)" data-cover ="${position_num}" class="form-control all_sum_assured sum_assured_readonly" name="cover_${position_num}_sum_assured" id="cover_${position_num}_sum_assured_readonly" style="display: none;" readonly>
                </div></div></div><div class="col-md-12"><div class="form-group"><label class="control-label col-md-4 col-sm-4" for="cover_` +
                position_num +
                '_premium">Premium :</label><div class="col-md-6 col-sm-6"><input class="form-control cover_premium" readonly type="text" id="cover_' +
                position_num + '_premium" name="cover_' + position_num +
                `_premium" value="0" /></div></div></div></div>`
