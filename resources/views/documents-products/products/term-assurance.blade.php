            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_1" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_2" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <div class="form-group">
                                        <label class="form-label" for="country_of_residence">Country Of Residence (State All If More
                                            Than One) *:</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="text" id="country_of_residence" name="nationality" value=""
                                                required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_3" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <form id="form_step_4" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                            ...
                            <div class="col-md-8 form-content" id="panel_for_stage_3">
                                ...
                                <div class="panel-body panel-form">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="number" id="sum_assured" name="sum_assured" required />
                                        </div>
                                    </div>
                
                                    <div class="form-group" id="medicals_info" style="display: none;">
                                        <label class="form-label" for="sum_assured" style="text-align: center;"><strong>Medicals are required for sum assured of
                                                GHS100,000</strong></label>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="premium">Annual Premium (Ghc) *:</label>
                                        <div class="col-md-12 col-sm-12 mb-3">
                                            <input class="form-control" type="text" min="1" id="premium" name="premium" readonly required />
                                            <ul class="parsley-errors-list filled" style="display: none;" id="premium-logic-prevent" aria-hidden="false">
                                                <li class="parsley-min" id="premium-logic-li">Your age makes you ineligible for this policy.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <form id="form_step_5" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_6" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                     ...
                     <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_7" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_8" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        <div class="d-flex justify-content-center">
                            <div class="col-md-8 form-content" id="panel_for_stage_5">
                                ...
                                <div class="panel-body panel-form">
                                    ...
                                    <span class="form-label" style="text-align: center;" for="health_issues2">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_9" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                    ...
                    <!--
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_10" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                        <input type="hidden" name="product_name" value="EDUCATOR" />
                        ...
                        ----------------------------------------------------------------------------------------------------------------
                    -->
                    <form id="form_step_11" style="display: none" class="step custom-validation" action="{{route('save-update-termassurance-request')}}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <input type="hidden" name="doc_appl_id" value="{{$document_applications_id}}">
                        <input type="hidden" name="rec_id" value="{{$existing_record[0]->id}}">
                            ...
                            <div class="col-md-8 form-content"  id="panel_for_stage_8">
                                ...
                                <div class="panel-body panel-form">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <span class="form-label" style="text-align: center;"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <span class="form-label" style="text-align: center;">Signature
                                                    Options</span>
                                                <div class="col-md-12 col-sm-12">
           ...
           for (let index = 0; index < $('.step').length; index++) {
            ...
            $(document).on('submit', 'form', function(e) {
                ...
                if(isValid){
                    ...
                    if(fullid == 'form_step_10'){ //can be modified based on form steps
...
<script>
    ...
    $('#sum_assured').on('input', function() {
        ...
        if (isNaN(age) || age < 18) {
            ...
            $('#premium-logic-li').html('You cannot be less than 18. Go back and fill your date of birth correctly');
            $('#premium-logic-prevent').css('display', 'block');
            setTimeout(() => {
                $('#premium-logic-prevent').css('display', 'none');
            }, 3000);
            return;
        }
        ...
        if (isNaN(this_sum_assured)) {
            ...
            $('#premium-logic-li').html('Sum assured has to be a number');
            $('#premium-logic-prevent').css('display', 'block');
            setTimeout(() => {
                $('#premium-logic-prevent').css('display', 'none');
            }, 3000);
        ...
        if (this_sum_assured > 1000000) {
            ...
            $('#premium-logic-li').html('The sum assured cannot be more than GHS 1,000,000');
            $('#premium-logic-prevent').css('display', 'block');
            setTimeout(() => {
                $('#premium-logic-prevent').css('display', 'none');
            }, 3000);
        ...
        if (age >= 18 && age <= 25) {
            ...
            this_premium = this_sum_assured * (6.3655 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 26 && age <= 30) {

            this_premium = this_sum_assured * (6.67 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 31 && age <= 35) {
            this_premium = this_sum_assured * (7.2355 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 36 && age <= 40) {
            this_premium = this_sum_assured * (8.758 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 41 && age <= 45) {

            this_premium = this_sum_assured * (11.4985 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 46 && age <= 50) {

            this_premium = this_sum_assured * (15.95 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 51 && age <= 55) {

            this_premium = this_sum_assured * (22.968 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else if (age >= 56 && age <= 59) {

            this_premium = this_sum_assured * (33.9735 / 1000);
            $('#premium').val(parseFloat(this_premium).toFixed(2));
            return;
        } else {
            // swal("Oops!", "Your age makes you ineligible for this policy", "error");
            $('#premium-logic-li').html('Your age makes you ineligible for this policy');
            $('#premium-logic-prevent').css('display', 'block');
            setTimeout(() => {
                $('#premium-logic-prevent').css('display', 'none');
            }, 3000);
