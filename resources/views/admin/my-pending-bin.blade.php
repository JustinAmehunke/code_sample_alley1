...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">My Pending Request Bin</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">My Pending Request Bin</h4>
                    <p class="card-title-desc"> </p>
                    <div class="mb-3">
                        {{ $proposals->links('pagination::bootstrap-5') }}
                    </div>
                    @if(count($proposals) > 0)
                    <table id="datatable" class="multi-datatable table table-bordered dt-responsive nowrap"
                        ...
                        <tbody>
                            @foreach($proposals as $key => $proposal)
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    <td>
                                        <a href="/product-request/request-profile?section='UmVxdWVzdC1Qcm9maWxl'&id={{base64_encode($proposal->tbl_document_applications->id)}}">
                                           {{ $proposal->tbl_document_applications->request_no }}
                                        </a>
                                    </td>
                                    <td>
                                        <a href="#">
                                    ...
                                    <td>{{ $proposal->tbl_document_applications->tbl_branch ? $proposal->tbl_document_applications->tbl_branch?->branch_name : '' }}</td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        //     serverSide: true,
        //     ajax: {
        //         url: "{{ route('get-pending-bin-dashboard') }}",
        //         type: "POST",
        //         data: function (data) {
        ...
        //         },
        //         {
        //             data: 'tbl_documents_products.product_name',
        //         },
        //             {
        //             data: 'tbl_users.full_name',
        //         },
        //         {
        //             data: 'tbl_document_applications.createdon',
        //         },
        //         {
        //             data: 'tbl_document_applications.last_updated_date',
        //         },
        //         {
        //             data: 'branch.branch_name',
        //         },
        //         {
        //             data: 'tbl_document_applications.source',
        //         },
        //         {
