                            ...
                            <tbody>
                                @foreach ($users as $key => $user)
                                    <tr>
										...
										<td>{{$user->email}}</td>
                                        <td>{{$user->mobile}}</td>
                                        <td>{{isset($user->department->department_name)?$user->department->department_name:''}}</td>
                                        <td>{{isset($user->designation->designations)?$user->designation->designations:''}}</td>
                                        <td>
                                            <div class="editable-buttons">
                                                <a href="{{ route('edit-menu', ['id' => encrypt($user->id)]) }}">
                                                    <button type="submit" class="btn btn-success editable-submit btn-sm waves-effect waves-light">
                                                        <i class="fa fa-pencil-square-o"></i>
                                                    </button>
                                                </a>
                                                <button type="button" onclick="detele({{$user->id}})" class="btn btn-danger editable-cancel btn-sm waves-effect waves-light"><i class="fa fa-trash-o"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
