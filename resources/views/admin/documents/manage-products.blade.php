                ...
                <div class="card-body">
                    <table class="table table-bordered mb-2">
                        ...
                        <tbody class="tr-cont-ep" id="tr-cont-ep">
                            <tbody>
                                @foreach ($document_products as $key => $document_product)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $document_product->product_name }}</td>
                                    ...
                                    <td>
                                        <div class="btn-group me-2 mb-2 mb-sm-0">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                <a class="dropdown-item" href="#203"><i class="fa fa-eye"></i> Preview</a>
                                                <a class="dropdown-item" href="{{ route('admin-document-view-product', ['id' =>base64_encode($document_product->id)]) }}" ><i class="fa fa-edit"></i> Edit Setting</a>
                                                <a class="dropdown-item" href="#203"><i class="fa fa-pencil"></i> Edit Proposal form</a>
                                                <a class="dropdown-item" href="#MjAz"><i class="fa fa-pencil"></i> Edit T&amp;C</a>
                                                <a class="dropdown-item" href="#MjAz"><i class="fa fa-trash-o"> </i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
