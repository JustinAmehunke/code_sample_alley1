...
<script>
        ...
        $('#datatable').DataTable({
            ...
            ajax: {
                ...
                data: function (data) {
                    ...
                    data.complaint_type = 'closed-admin';
                }
            },
            order: ['1', 'DESC'],
            pageLength: 10,
                    ...
                    render: function(data, type, row) {
                        ...
                        <div class="btn-group me-2 mb-2 mb-sm-0">
                                ...
                                <div class="dropdown-menu" style="">
                                    ...
                                    <a href="#modal-dialog" data-id="${btoa(id)}" data-action="${btoa('update')}" class="init-action dropdown-item"><i class="far fa-edit"></i> Update Request</a>
                                </div>
                            </div>
                        `;
                    }
    ...
    $(document).on('submit','#update-finalForm', function(event) {
        event.preventDefault();
        var formData = $(this).serialize();
        $.ajax({
            url: "{{route('customer.complaints.handle.update-final')}}", 
            method: 'POST',
            data: formData,
            success: function(resp) {
                // Handle the success response here
