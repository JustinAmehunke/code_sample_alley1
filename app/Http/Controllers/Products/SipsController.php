        ...
        if (isset($request->doc_appl_id) && $request->doc_appl_id !== null){
            ...
            if($document_application !== null){
                try {
                    ...
                    $beneficiaryFields = [];
                    $coverFields = [];
                    $excludeFields = ['_token', 'other_payment_term', 'doc_appl_id', 'rec_id', 'product_name', 'flexdatalist-occupation', 'flexdatalist-empoyment_occupation', 'flexdatalist-empoyment_employer', 'flexdatalist-agent_code', 'flexdatalist-employer', 'product_beneficiary','product_cover','product_signature', 'flexdatalist-empoyment_employer', 'flexdatalist-empoyment_occupation'];
                    ...
                    if(isset($request->product_name)){
                        ...
                        Sip::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        if($request->how_did_you_hear == "Self-Discovery"){
                            Sip::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        $filled = Sip::where('tbl_document_applications_id', $doc_id)->first();
