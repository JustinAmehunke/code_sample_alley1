...
class CorporateDueDiligencesController extends Controller
{
        ...
        if (isset($request->doc_appl_id) && $request->doc_appl_id !== null){
            ...
            if($document_application !== null){
                try {
                    ...
                    $beneficiaryFields = [];
                    $coverFields = [];
                    $excludeFields = ['_token', 'doc_appl_id', 'rec_id', 'product_name', 'flexdatalist-occupation', 'flexdatalist-agent_code', 'flexdatalist-empoyment_occupation', 'flexdatalist-empoyment_employer', 'flexdatalist-employer', 'product_beneficiary','product_cover','product_signature', 'flexdatalist-empoyment_employer', 'flexdatalist-empoyment_occupation'];
                    ...
                    if(isset($request->product_name)){
                        ...
                        CorporateDueDiligence::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_beneficiary)){
                        ...
                        //delete previous
                        CorporateBeneficiary::where('tbl_document_applications_id', $doc_id)->delete();
                        foreach ($request->beneficiary_full_name as $key => $fullName) {
                            // Create a new Beneficiary instance
                            $beneficiary = new CorporateBeneficiary();
                    ...
                    if(isset($request->product_signature)){
                        ...
                        //     CorporateDueDiligence::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        $filled = CorporateDueDiligence::where('tbl_document_applications_id', $doc_id)->first();
