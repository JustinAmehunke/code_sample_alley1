                ...
                try {
                    ...
                    if(isset($request->product_name)){
                        foreach ($request->all() as $field => $value) {
                            // Check if the field is not empty in the request source_of_payment_option claimpayment_payment_option
                           
                            if(!in_array($field, $excludeFields)){
                                if (!empty($value)) {
                                    if($field == 'claimpayment_payment_option'){$customizedFields["payment_option"] = $value;}

                                    else if($field == 'claimpayment_of_telco_name'){$customizedFields["telco_name"] = $value;}
                                    else if($field == 'claimpayment_of_wallet_number'){$customizedFields["wallet_number"] = $value;}
                                    else if($field == 'claimpayment_of_wallet_name'){$customizedFields["wallet_name"] = $value;}

                                    else if($field == 'claimpayment_of_payment_bank_name'){$customizedFields["payment_bank_name"] = $value;}
                                    else if($field == 'claimpayment_of_bank_branch'){$customizedFields["payment_bank_branch"] = $value;}
                                    else if($field == 'claimpayment_of_account_number'){$customizedFields["account_number"] = $value;}
                                    else if($field == 'claimpayment_of_account_holder_name'){$customizedFields["account_holder_name"] = $value;}
                                    else{
                                    ...
                                    if($field == 'claimpayment_payment_option'){$customizedFields["payment_option"] = $document_application->$field;}

                                    else if($field == 'claimpayment_of_telco_name'){$customizedFields["telco_name"] = $document_application->$field;}
                                    else if($field == 'claimpayment_of_wallet_number'){$customizedFields["wallet_number"] = $document_application->$field;}
                                    else if($field == 'claimpayment_of_wallet_name'){$customizedFields["wallet_name"] = $document_application->$field;}
                                    else if($field == 'claimpayment_of_payment_bank_name'){$customizedFields["payment_bank_name"] = $document_application->$field;}
                                    else if($field == 'claimpayment_of_bank_branch'){$customizedFields["payment_bank_branch"] = $document_application->$field;}
                                    else if($field == 'claimpayment_of_account_number'){$customizedFields["account_number"] = $document_application->$field;}
                                    else if($field == 'claimpayment_of_account_holder_name'){$customizedFields["account_holder_name"] = $document_application->$field;}
                                    else{
                        ...
                        RefundRequest::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        //     RefundRequest::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        $filled = RefundRequest::where('tbl_document_applications_id', $doc_id)->first();
