        ...
        if (isset($request->doc_appl_id) && $request->doc_appl_id !== null){
            ...
            if($document_application !== null){
                try {
                    ...
                    $beneficiaryFields = [];
                    $coverFields = [];
                    $excludeFields = ['_token', 'doc_appl_id', 'rec_id', 'product_name', 'flexdatalist-occupation', 'flexdatalist-agent_code', 'flexdatalist-employer','flexdatalist-empoyment_occupation', 'flexdatalist-empoyment_employer', 'product_beneficiary','product_cover','product_signature'];
                    ...
                    if(isset($request->product_name)){
                        ...
                        Educator::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        $filled = Educator::where('tbl_document_applications_id', $doc_id)->first();
