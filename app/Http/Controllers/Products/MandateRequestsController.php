...
class MandateRequestsController extends Controller
{
            ...
            if($document_application !== null){
                try {
                    ...
                    if(isset($request->product_name)){
                        ...
                        MandateRequest::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        //     MandateRequest::where('tbl_document_applications_id', $doc_id)->update([
