...
class DeathClaimsController extends Controller
{
            ...
            if($document_application !== null){
                try {
                    ...
                    if(isset($request->product_name)){
                        ...
                        DeathClaim::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        //     DeathClaim::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        $filled = DeathClaim::where('tbl_document_applications_id', $doc_id)->first();
