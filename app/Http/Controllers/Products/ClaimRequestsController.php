            ...
            if($document_application !== null){
                try {
                    ...
                    if(isset($request->product_name)){
                        ...
                        ClaimRequest::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        //     ClaimRequest::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        $filled = ClaimRequest::where('tbl_document_applications_id', $doc_id)->first();
