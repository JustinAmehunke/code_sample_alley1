...
class PersonalAccidentsController extends Controller
{
        ...
        if (isset($request->doc_appl_id) && $request->doc_appl_id !== null){
            ...
            if($document_application !== null){
                try {
                    ...
                    $beneficiaryFields = [];
                    $coverFields = [];
                    $excludeFields = ['_token', 'doc_appl_id', 'rec_id', 'product_name', 'flexdatalist-empoyment_occupation', 'flexdatalist-empoyment_employer', 'flexdatalist-occupation', 'flexdatalist-agent_code', 'flexdatalist-employer', 'product_beneficiary','product_cover','product_signature', 'flexdatalist-empoyment_employer', 'flexdatalist-empoyment_occupation'];
                    ...
                    if(isset($request->product_name)){
                        ...
                        PersonalAccident::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        if($request->how_did_you_hear == "Self-Discovery"){
                            PersonalAccident::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        $filled = PersonalAccident::where('tbl_document_applications_id', $doc_id)->first();
