...
class KeymansController extends Controller
{
        ...
        if (isset($request->doc_appl_id) && $request->doc_appl_id !== null){
            ...
            if($document_application !== null){
                try {
                    ...
                    $beneficiaryFields = [];
                    $coverFields = [];
                    $excludeFields = ['_token', 'doc_appl_id', 'age', 'rec_id', 'product_name', 'flexdatalist-empoyment_occupation', 'flexdatalist-empoyment_employer', 'flexdatalist-occupation', 'flexdatalist-agent_code', 'flexdatalist-employer', 'product_beneficiary','product_cover','product_signature', 'flexdatalist-empoyment_employer', 'flexdatalist-empoyment_occupation'];
                    ...
                    if(isset($request->product_name)){
                        ...
                        Keyman::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        if($request->how_did_you_hear == "Self-Discovery"){
                            Keyman::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        if($request->signopt == 2){ //upload
                            if (empty($rec['uploaded_signature'])) {
                                if ($request->hasFile('sign_img')) {
                                    ...
                                    Educator::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        $filled = Keyman::where('tbl_document_applications_id', $doc_id)->first();
