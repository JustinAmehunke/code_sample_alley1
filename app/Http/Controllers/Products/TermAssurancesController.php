...
class TermAssurancesController extends Controller
{
            ...
            if($document_application !== null){
                try {
                    ...
                    if(isset($request->product_name)){
                        ...
                        TermAssurance::where('tbl_document_applications_id', $doc_id)->update($customizedFields);
                    }
                    ...
                    if(isset($request->product_signature)){
                        ...
                        if($request->how_did_you_hear == "Self-Discovery"){
                            TermAssurance::where('tbl_document_applications_id', $doc_id)->update([
                        ...
                        $filled = TermAssurance::where('tbl_document_applications_id', $doc_id)->first();
